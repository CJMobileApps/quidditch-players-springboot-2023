...
class StatusControllerTest : BaseIntegrationTest() {
    ...
    @Test
    fun `getStatusByPlayerId success call`(): Unit = runBlocking {
    ...
    @Test
    fun `getStatusByPlayerId throw clientException`(): Unit = runBlocking {

        // given
        val response = ResponseEntityWrapper<Status>(
            data = null,
            error = Error(
                isError = true,
    ...
    @Test
    fun `getStatusByPlayerId throw internalException`(): Unit = runBlocking {
    ...
    @Test
    fun `getStatusByHouseName success call`(): Unit = runBlocking {
    ...
    @Test
    fun `getStatusByHouseName throw clientException`(): Unit = runBlocking {
    ...
    @Test
    fun `getStatusByHouseName throw internalException`(): Unit = runBlocking {
